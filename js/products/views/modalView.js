			...
			'<div class="row">',
				...
				'<div class="column large-6 medium-6 custom-column">',
					'<div class="product-details">',
						'<div class="price">',
							'<% if (price.old) {%>',
								'<p class="curent-price new"><span class="currency"></span><span class="value"><%= price.current %></span></p>',
								'<p class="old-price"><span class="currency"></span><span class="value"><%= price.old %></span></p>',
							'<% } else {%>',
								'<p class="curent-price"><span class="currency"></span><span class="value"><%= price.current %></span></p>',
							'<% } %>',
						'</div>',
						'<div class="title">',
							'<h4><%= name %></h4>',
